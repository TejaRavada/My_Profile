...
const ResumeComp = () => {
    ...
    const topices = [
        ...
        },
        {
            ...
            sub_heading1: 'Description',
            sub_Text1: 'Hindi story & Day Dream is a animation videos channels. This channel contains all videos related to moral stories and fariy tale stories, fariy tale stories, horror stories and I create background degisns, character design, story for full props I created.',
            sub_heading2: 'Clients',
        ...
        },
        {
            ...
            sub_heading1: 'Description',
            sub_Text1: 'The UI design project focuses on creating an intuitive and visually appealing user interface for a content-driven website. The design includes a clean, minimalistic layout with a balanced use of whitespace to enhance readability. Key features include a responsive grid system for seamless viewing across devices, a sticky navigation bar for easy access to different sections, and well-defined typography to improve content engagement. Interactive elements such as hover effects and smooth transitions are incorporated to enrich the user experience. The color palette is thoughtfully chosen to align with the brand’s identity, ensuring consistency and professionalism throughout the site. The project utilizes industry-standard software such as Adobe XD and Figma for design and prototyping, ensuring precision and collaborative feedback. Front-end development topics covered include HTML, CSS, JavaScript, and React for building dynamic and interactive components. CSS frameworks like Bootstrap are used for responsive design, while tools like Webpack and Babel streamline the development process. Version control is managed with Git, enabling efficient collaboration and code management',
            sub_heading2: 'Clients',
        ...
        },
        {
            ...
            sub_heading1: 'Description',
            sub_Text1: 'The UI design project focuses on creating an intuitive and visually appealing user interface for a content-driven website. The design includes a clean, minimalistic layout with a balanced use of whitespace to enhance readability. Key features include a responsive grid system for seamless viewing across devices, a sticky navigation bar for easy access to different sections, and well-defined typography to improve content engagement. Interactive elements such as hover effects and smooth transitions are incorporated to enrich the user experience. The color palette is thoughtfully chosen to align with the brand’s identity, ensuring consistency and professionalism throughout the site.',
            sub_heading2: 'Clients',
                            ...
                            <div key={index} className="project_Text">
                                ...
                                <div className="project_topices">
                                    <div className="project_sub project_subs">
                                        ...
                                        <p className='link'><Link to={item.link} target="_blank" rel="noopener noreferrer"></Link>View Link</p>
                                    </div>
                                </div>
                            </div>
                        ))
