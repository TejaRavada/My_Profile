...
import { setLineHeight, setStopHeight, fetchExperienceData } from '../../../app/actions';
import { selectLineHeight, selectStopHeight, selectExperienceData } from '../../../app/selectors';
...
const Experience = () => {
  ...
  const experienceData = useSelector((state) => state.scroll.experienceData);

  useEffect(() => {
    dispatch(fetchExperienceData());// Fetch data when component mounts
  ...
  return (
    <div className="timeline">
      <div className="timeline-line timeline-line2">
      ...
      <div className="items">
        {experienceData.map((event, index) => (
          <div
            ...
            ref={index === experienceData.length - 4 ? lastEventRef : null} // Ref to the last event
          >
